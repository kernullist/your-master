...
- Desktop: read or set the clipboard, take a screenshot (the whole screen, or just one window by its title — e.g. capture only the VMware window), and read system info (CPU/memory/OS).
